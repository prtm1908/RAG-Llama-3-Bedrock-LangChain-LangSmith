...
session = boto3.session.Session(region_name='us-east-1',aws_access_key_id=os.environ.get('aws_access_key_id'),aws_secret_access_key=os.environ.get('aws_secret_access_key'))
...
def get_context(question: str):
    ...
    return {"response": extracted_paragraph.strip()}, response_payload
